...
<form class="form_container" method="POST">
  ...
  <div class="input_container">
    ...
    <input placeholder="name@email.com" title="Inpit title" name="name" type="text" class="input_field" id="email_field">
  </div>
  <div class="input_container">
    ...
    <input placeholder="Password" title="Inpit title" name="pw" type="password" class="input_field" id="password_field">
  </div>
  <button title="Sign In" type="submit" class="sign-in_btn" name="kirim">
    <span>Sign In</span>
  </button>
</form>
</div>
...
if (isset($_POST['kirim'])) {
  ...
  if ($akunyangcocok ==  1) {
    ...
    echo "<script> alert('Login Gagal, Silahkan Periksa Kembali Akun Anda') </script>";
